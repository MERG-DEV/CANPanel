...
;*	Based on the Microchip bootloader of which full acknowledgement is made.
;*	Relevant information is contained in the Microchip Application note AN247

;   This part of the software is distributed under the Microchip
...
;   CBUS software as a "system library" as defined in section 1 of the GNU Public
...
#define	CAN_BRGCON1		B'00000111'	;CAN bit rate controls. For 8 MHz and CAN_CMD only
